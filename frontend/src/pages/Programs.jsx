      ...
      <section className="relative py-20 md:py-28 bg-[#0B1D39] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Real Support for Real Heroes — Empowering veterans to achieve
            stability and dignity through targeted financial assistance.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#3C4A5B] max-w-3xl mx-auto">
              All4Vets provides targeted financial assistance through three core
              programs designed to remove financial barriers and help veterans
              thrive.
            </p>
          </div>
                  ...
                  <Card className="overflow-hidden border-2 hover:border-[#1E4F91] transition-all duration-300">
                    <CardContent className="p-0">
                      ...
                      >
                        ...
                        <div className="p-8 md:p-12">
                          ...
                          <div className="mb-6">
                            <h4 className="text-lg font-bold text-[#0B1D39] mb-3">
                              {program.whatItCovers
                                ? "What It Covers:"
                                : program.whatItSupports
                                  ? "What It Supports:"
                                  : "Emergency Aid Covers:"}
                            </h4>
                            <ul className="space-y-2">
                              {(
                                program.whatItCovers ||
                                program.whatItSupports ||
                                program.emergencyAidCovers
                              )?.map((item, i) => (
                          ...
                          {program.howItWorks && (
                            <div className="mb-6 p-4 bg-[#F3F5F7] rounded-lg">
                              <h4 className="text-lg font-bold text-[#0B1D39] mb-2">
                                How It Works:
                              </h4>
                              ...
                              <ul className="space-y-2">
                                {program.impactGoals.map((goal, i) => (
                                  <li key={i} className="flex items-start">
                                    <ArrowRight
                                      size={20}
                                      className="text-[#BF9B30] mr-3 flex-shrink-0 mt-0.5"
                                    />
                        ...
                        {/* Image Side */}
                        <div
                          className={`bg-[#F3F5F7] flex items-center justify-center p-8 ${!isEven ? "lg:order-first" : ""}`}
                        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {guidingPrinciples.map((principle, index) => {
              ...
              return (
                <Card
                  key={principle.id}
                  className="bg-white border-2 hover:border-[#BF9B30] transition-all duration-300"
                >
      ...
      <section className="py-16 md:py-20 bg-[#0B1D39] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            If you're a veteran in need of assistance, we're here to help. Apply
