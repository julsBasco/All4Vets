...
import { ArrowRight, Check, X, Building2, Award, Briefcase, Mail, Phone, Globe } from 'lucide-react';
...
const Sponsorship = () => {
  ...
  const sponsorshipTiers = [
    {
      ...
      description: 'Our highest level of partnership, providing maximum visibility and impact. Platinum sponsors receive exclusive recognition and direct involvement in our mission.',
      featured: true,
      benefits: [
    ...
    },
    {
      ...
      amount: '$10,000+',
      period: 'Annual Commitment',
      description: 'A significant partnership level offering substantial recognition and meaningful engagement with our veteran community and mission.',
      featured: false,
      benefits: [
    ...
    },
    {
      ...
      amount: '$5,000+',
      period: 'Annual Commitment',
      description: 'An excellent entry-level partnership providing meaningful support to veterans while gaining valuable recognition for your corporate social responsibility.',
      featured: false,
      benefits: [
  ...
  const comparisonData = [
    { benefit: 'Website Logo Placement', platinum: 'Homepage', gold: 'Prominent', silver: 'Sponsor Page' },
    { benefit: 'Annual Report Recognition', platinum: 'Featured', gold: true, silver: true },
    { benefit: 'Social Media Posts (Quarterly)', platinum: '4', gold: '2', silver: '1' },
    { benefit: 'Impact Reports', platinum: 'Quarterly', gold: 'Quarterly', silver: 'Semi-Annual' },
    { benefit: 'Gala Event Tickets', platinum: 'VIP + Speaking', gold: '2 Tickets', silver: '1 Ticket' },
    { benefit: 'Press Release', platinum: true, gold: false, silver: false },
    { benefit: 'Naming Rights Opportunity', platinum: true, gold: false, silver: false },
    { benefit: 'Custom Impact Video', platinum: true, gold: false, silver: false },
    { benefit: 'Leadership Consultation', platinum: 'Direct Access', gold: 'Bi-Annual', silver: false },
    { benefit: 'Employee Volunteer Opportunities', platinum: true, gold: true, silver: true },
    { benefit: 'Recognition Plaque/Certificate', platinum: 'Premium Plaque', gold: 'Certificate', silver: 'Certificate' },
    { benefit: 'Tax Deduction (501c3)', platinum: true, gold: true, silver: true },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-[#BF9B30] mb-6">
              ...
              <span className="text-sm font-medium">Corporate Partnership Program</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-6">
              Corporate Sponsorship Program
            </h1>
            <p className="text-xl text-gray-200 max-w-3xl mx-auto leading-relaxed">
              Partner with All4Vets to make a lasting impact on the lives of veterans and their families.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#3C4A5B] max-w-4xl mx-auto leading-relaxed">
              All4Vets is a 501(c)(3) nonprofit organization dedicated to providing independent guidance, direct aid, 
              and expert connections for veterans seeking VA disability benefits. Your corporate sponsorship directly 
              supports veterans in financial hardship, helping them access the medical care and support they've earned 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {impactStats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-sm text-[#3C4A5B]">
                  {stat.description}
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#3C4A5B] max-w-2xl mx-auto">
              Select the sponsorship tier that aligns with your company's commitment to supporting our nation's veterans
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={`${colors.header} text-white p-6 text-center`}>
                    <div className={`inline-block ${colors.badge} text-xs font-bold px-3 py-1 rounded-full mb-3`}>
                      {tier.badge}
                    </div>
                    <h3 className="text-2xl font-bold mb-2">{tier.name}</h3>
                    <div className="text-3xl font-black mb-1">{tier.amount}</div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="mb-6">
                      <h4 className="font-bold text-[#0B1D39] mb-4 flex items-center">
                        ...
                        {tier.featured ? 'Exclusive Benefits' : tier.color === 'gold' ? 'Premium Benefits' : 'Supporting Benefits'}
                      </h4>
                      <ul className="space-y-3">
                        {tier.benefits.map((benefit, idx) => (
                          <li key={idx} className="flex items-start text-sm text-[#3C4A5B]">
                    ...
                    <Link to="/contact">
                      <Button className={`w-full ${colors.button} font-bold py-3 rounded-full transition-all duration-200`}>
          ...
          <div className="mt-12 bg-white rounded-xl p-8 shadow-lg border-2 border-[#1E4F91]">
            <div className="text-center">
              ...
              <p className="text-[#3C4A5B] max-w-2xl mx-auto mb-6 leading-relaxed">
                Looking for a tailored sponsorship package? We're happy to work with you to create a custom 
                partnership that aligns with your company's goals and budget. Contact us to discuss in-kind 
                donations, program-specific sponsorships, or multi-year commitments.
              </p>
              <Link to="/contact">
              ...
              <thead>
                <tr className="bg-[#0B1D39] text-white">
                  ...
                  <th className="text-center p-4 font-bold">
                    <div>Platinum</div>
                    <div className="text-sm font-normal text-[#BF9B30]">$25,000+</div>
                  </th>
                  <th className="text-center p-4 font-bold">
                    <div>Gold</div>
                    <div className="text-sm font-normal text-[#BF9B30]">$10,000+</div>
                  </th>
                  <th className="text-center p-4 font-bold">
                    <div>Silver</div>
                    <div className="text-sm font-normal text-[#BF9B30]">$5,000+</div>
                  </th>
                </tr>
              </thead>
              <tbody>
                {comparisonData.map((row, index) => (
                  ...
                  >
                    <td className="p-4 font-medium text-[#0B1D39]">{row.benefit}</td>
                    <td className="p-4 text-center">{renderCheckOrX(row.platinum)}</td>
                    <td className="p-4 text-center">{renderCheckOrX(row.gold)}</td>
                    <td className="p-4 text-center">{renderCheckOrX(row.silver)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-20 bg-gradient-to-br from-[#0B1D39] via-[#1E4F91] to-[#0B1D39] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Join us in supporting veterans who have served our nation. Let's discuss how your company can become a valued partner in our mission.
          </p>
          ...
          <p className="mt-10 text-sm text-gray-300">
            All4Vets is a registered 501(c)(3) nonprofit organization. Your sponsorship is tax-deductible to the extent allowed by law.<br />
            EIN: {siteConfig.ein}
          </p>
        </div>
      </section>
